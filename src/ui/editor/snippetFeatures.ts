...
export async function _showVariableQuickPick(): Promise<string | undefined> {
	const variables = [
		...
		{ label: 'USERNAME', description: "Your git username or 'unknown'" },
	];
