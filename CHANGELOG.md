...
- command to quick open snippetstudio uses correct view container name
- removed all ui-only commands from the command palette

## [4.2.0] - 2026-04-10

### Added

- Support for string array snippet descriptions
- Multiline descriptions will save as an array

### Fixed

- Manually defined description arrays appear correctly in tooltips
- Descriptions with newlines appear correctly in tooltips
- Snippet description arrays will be parsed correctly when loaded into the snippet editor
...
- Selecting language more intuitive by recommending editor's active language first
...
- Prevent editing extension snippets via snippet file edit decorations
- Improved detection of extension snippets using TextMate scope selectors
...
- Drag and Drop to move & reorder snippets

### Fixed

- Crash for users with a nearly brand new IDE
- Confirm deletion setting won't apply when moving snippets
